...
class TraceLogger:
    ...
    def get_traces(self, limit: int = 100, agent: str | None = None) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for run in client.list_runs(**kwargs):
                ...
                results.append({
                    ...
                    "agent": run.name or "",
                    "car_id": (run.extra or {}).get("metadata", {}).get("car_id", ""),
                    ...
                    "model": (run.extra or {}).get("invocation_params", {}).get("model", ""),
                })
            return results
        except Exception:
            return []
    ...
    def get_stats(self, hours: int = 24) -> dict[str, Any]:
        empty = {
            ...
            "p99_latency_ms": 0, "error_count": 0, "error_rate": 0,
        }
        if not _langsmith_available():
            return empty
        try:
